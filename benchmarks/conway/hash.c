            ...
            (void) x12;
            {
                ...
                while ((x19 >= 0 ? x17 <= x18 : x17 >= x18)) {
                    ...
                    (void) x20;
                    {
                        ...
                        TValue * x22 /* slot */;
                        if (TITAN_LIKELY(x21 < x16->sizearray)) {
                            x22 = &x16->array[x21];
                        } else {
                            TValue x23;
                            setivalue(&x23, x21+1);
                ...
                TValue * x25 /* slot */;
                if (TITAN_LIKELY(x24 < x8->sizearray)) {
                    x25 = &x8->array[x24];
                } else {
                    TValue x26;
                    setivalue(&x26, x24+1);
    ...
    (void)x6;
    {
        ...
        while ((x12 >= 0 ? x10 <= x11 : x10 >= x11)) {
            ...
            (void) x13;
            {
                ...
                if (TITAN_LIKELY(x14 < x3->sizearray)) {
                    x15 = &x3->array[x14];
                } else {
                    ...
                    {
                        {
                            ...
                            if (TITAN_LIKELY(x30 < x17->sizearray)) {
                                x31 = &x17->array[x30];
                            } else {
    ...
    (void)x9;
    {
        ...
        while ((x13 >= 0 ? x10 <= x12 : x10 >= x12)) {
            ...
            (void) x14;
            {
                ...
                if (TITAN_LIKELY(x20 < x4->sizearray)) {
                    x21 = &x4->array[x20];
                } else {
                ...
                if (TITAN_LIKELY(x24 < x3->sizearray)) {
                    x25 = &x3->array[x24];
                } else {
                ...
                while ((x31 >= 0 ? x28 <= x30 : x28 >= x30)) {
                    ...
                    (void) x32;
                    {
                        ...
                        if (TITAN_LIKELY(x38 < x23->sizearray)) {
                            x39 = &x23->array[x38];
                        } else {
                        ...
                        TValue * x42 /* slot */;
                        if (TITAN_LIKELY(x41 < x27->sizearray)) {
                            x42 = &x27->array[x41];
                        } else {
                            TValue x43;
                            setivalue(&x43, x41+1);
    ...
    (void)x7;
    {
        ...
        while ((x10 >= 0 ? x8 <= x9 : x8 >= x9)) {
            ...
            (void) x11;
            {
                ...
                const TValue * x21 /* arrslot */;
                if (TITAN_LIKELY(x20 < x3->sizearray)) {
                    x21 = &x3->array[x20];
                } else {
                ...
                if (TITAN_LIKELY(x28 < x3->sizearray)) {
                    x29 = &x3->array[x28];
                } else {
                ...
                if (TITAN_LIKELY(x32 < x4->sizearray)) {
                    x33 = &x4->array[x32];
                } else {
                ...
                while ((x38 >= 0 ? x36 <= x37 : x36 >= x37)) {
                    ...
                    (void) x39;
                    {
                        ...
                        if (TITAN_LIKELY(x48 < x23->sizearray)) {
                            x49 = &x23->array[x48];
                        } else {
                        ...
                        if (TITAN_LIKELY(x52 < x23->sizearray)) {
                            x53 = &x23->array[x52];
                        } else {
                        ...
                        if (TITAN_LIKELY(x56 < x23->sizearray)) {
                            x57 = &x23->array[x56];
                        } else {
                        ...
                        if (TITAN_LIKELY(x60 < x27->sizearray)) {
                            x61 = &x27->array[x60];
                        } else {
                        ...
                        if (TITAN_LIKELY(x64 < x27->sizearray)) {
                            x65 = &x27->array[x64];
                        } else {
                        ...
                        if (TITAN_LIKELY(x68 < x27->sizearray)) {
                            x69 = &x27->array[x68];
                        } else {
                        ...
                        if (TITAN_LIKELY(x72 < x31->sizearray)) {
                            x73 = &x31->array[x72];
                        } else {
                        ...
                        if (TITAN_LIKELY(x76 < x31->sizearray)) {
                            x77 = &x31->array[x76];
                        } else {
                        ...
                        if (TITAN_LIKELY(x80 < x31->sizearray)) {
                            x81 = &x31->array[x80];
                        } else {
                        ...
                        lua_Integer x91 /* sum */ = x90;
                        {
                            ...
                            if (x96) {
                                ...
                                TValue * x101 /* slot */;
                                if (TITAN_LIKELY(x100 < x35->sizearray)) {
                                    x101 = &x35->array[x100];
                                } else {
                                    TValue x102;
                                ...
                                TValue * x93 /* slot */;
                                if (TITAN_LIKELY(x92 < x35->sizearray)) {
                                    x93 = &x35->array[x92];
                                } else {
                                    TValue x94;
                                    setivalue(&x94, x92+1);
...
int luaopen_benchmarks_conway_hash(lua_State *L)
{
    lua_checkstack(L, 4);
