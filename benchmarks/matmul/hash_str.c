            ...
            (void) x40;
            {
                ...
                while ((x47 >= 0 ? x45 <= x46 : x45 >= x46)) {
                    ...
                    (void) x48;
                    {
                        ...
                        TValue *x59array = x59->array;
                        lua_Unsigned x59size = x59->sizearray;

                        TValue *x44array = x44->array;
                        lua_Unsigned x44size = x44->sizearray;
                        ...
                        while ((x62 >= 0 ? x60 <= x61 : x60 >= x61)) {
                            ...
                            (void) x63;
                            {
                                ...
                                if (TITAN_LIKELY(x64 < x59size)) {
                                    x65 = x59array;
                                } else {
                                    x65 = luaH_getint(x59, x63);
                                    x59array = &x59->array[x64];
                                    x59size = x59->sizearray;
                                }
                                ...
                                if (TITAN_LIKELY(x64 < x44size)) {
                                    x68 = x44array;
                                } else {
                                    x68 = luaH_getint(x44, x63);
                                    x44array = &x44->array[x64];
                                    x44size = x44->sizearray;
                                }
                                ...
                                /* We use the x65 slot for Ci */
                                chgfltvalue((TValue *)x65, x71);
                            }
                            x60 = intop(+, x60, x62);
                            x59array += 1;
                            x44array += 1;
...
int luaopen_benchmarks_matmul_hash_str(lua_State *L)
{
    lua_checkstack(L, 4);
