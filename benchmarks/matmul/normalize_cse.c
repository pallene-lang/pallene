                    ...
                    (void) x46;
                    {
                        ...
                        while ((x60 >= 0 ? x58 <= x59 : x58 >= x59)) {
                            ...
                            (void) x61;
                            {
                                ...
                                if (TITAN_UNLIKELY(x62 >= x57->sizearray)) {
                                    titan_renormalize_array(L, x57, x62, 19);
                                }
                                ...
                                if (TITAN_UNLIKELY(x62 >= x42->sizearray)) {
                                    titan_renormalize_array(L, x42, x62, 19);
                                }
...
int luaopen_benchmarks_matmul_normalize_cse(lua_State *L)
{
    lua_checkstack(L, 4);
