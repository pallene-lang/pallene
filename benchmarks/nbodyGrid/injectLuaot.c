...
// source = @benchmarks/nbodyGrid/injectLua.lua
// main function
static
void magic_implementation_00(lua_State *L, CallInfo *ci)
{
 ...
 tailcall:
  ...
  // 7	[44]	SETFIELD 	3 0 0	; "update_speeds"
  #undef  LUA_AOT_PC
  ...
  // 8	[45]	SETFIELD 	3 1 1	; "update_position"
  #undef  LUA_AOT_PC
  ...
  label_09 : {
    aot_vmfetch(0x0001824d);
    Proto *p = cl->p->p[GETARG_Bx(i)];
    halfProtect(pushclosure(L, p, cl->upvals, base, ra));
    checkGC(L, ra + 1);
  }
  
  // 11	[48]	SETFIELD 	3 3 4	; "inject_update_speeds"
  #undef  LUA_AOT_PC
  ...
  // 13	[49]	SETFIELD 	3 4 4	; "inject_update_position"
  #undef  LUA_AOT_PC
...
void magic_implementation_04(lua_State *L, CallInfo *ci)
{
 ...
 tailcall:
  ...
  // 1	[48]	SETUPVAL 	0 0	; update_speeds
  #undef  LUA_AOT_PC
  #define LUA_AOT_PC (function_code + 1)
  #undef  LUA_AOT_NEXT_JUMP
  #undef  LUA_AOT_SKIP1
...
void magic_implementation_05(lua_State *L, CallInfo *ci)
{
 ...
 tailcall:
  ...
  // 1	[49]	SETUPVAL 	0 0	; update_position
  #undef  LUA_AOT_PC
  #define LUA_AOT_PC (function_code + 1)
  #undef  LUA_AOT_NEXT_JUMP
  #undef  LUA_AOT_SKIP1
...
static const char LUA_AOT_MODULE_SOURCE_CODE[] = {
  ...
  116, 105, 111, 110,  40,  98, 105,  44,  32, 100, 116,  41,  10,  32,  32,  32, 
   ...
   32,  32,  32, 117, 112, 100,  97, 116, 101,  95, 115, 112, 101, 101, 100, 115, 
   32,  61,  32, 117, 112, 100,  97, 116, 101,  95, 115, 112, 101, 101, 100, 115, 
   44,  10,  32,  32,  32,  32, 117, 112, 100,  97, 116, 101,  95, 112, 111, 115, 
  105, 116, 105, 111, 110,  32,  61,  32, 117, 112, 100,  97, 116, 101,  95, 112, 
  111, 115, 105, 116, 105, 111, 110,  44,  10,  32,  32,  32,  32,  97, 100, 118, 
   97, 110,  99, 101,  32,  61,  32,  97, 100, 118,  97, 110,  99, 101,  44,  10, 
   10,  32,  32,  32,  32, 105, 110, 106, 101,  99, 116,  95, 117, 112, 100,  97, 
  116, 101,  95, 115, 112, 101, 101, 100, 115,  32,  32,  32,  61,  32, 102, 117, 
  110,  99, 116, 105, 111, 110,  40, 102,  41,  32, 117, 112, 100,  97, 116, 101, 
   95, 115, 112, 101, 101, 100, 115,  32,  61,  32, 102,  32, 101, 110, 100,  44, 
   10,  32,  32,  32,  32, 105, 110, 106, 101,  99, 116,  95, 117, 112, 100,  97, 
  116, 101,  95, 112, 111, 115, 105, 116, 105, 111, 110,  32,  61,  32, 102, 117, 
  110,  99, 116, 105, 111, 110,  40, 102,  41,  32, 117, 112, 100,  97, 116, 101, 
   95, 112, 111, 115, 105, 116, 105, 111, 110,  32,  61,  32, 102,  32, 101, 110, 
  100,  44,  10, 125,  10,   0
};
 
#define LUA_AOT_LUAOPEN_NAME luaopen_benchmarks_nbodyGrid_injectLuaot
