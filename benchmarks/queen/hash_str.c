...
static void function_printsolution_titan(
    ...
    (void)x5;
    {
        ...
        lua_Unsigned x2size = x2->sizearray;
        TValue *x2array = x2->array;
...
int luaopen_benchmarks_queen_hash_str(lua_State *L)
{
    lua_checkstack(L, 4);
