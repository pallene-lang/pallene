...
// source = @benchmarks/queen/lua.lua
// main function
static
...
static const char LUA_AOT_MODULE_SOURCE_CODE[] = {
  ...
  101, 110, 100,  10,  10, 114, 101, 116, 117, 114, 110,  32, 123,  10,  32,  32, 
   32,  32, 110, 113, 117, 101, 101, 110, 115,  32,  61,  32, 110, 113, 117, 101, 
  101, 110, 115,  44,  10, 125,  10,   0
};
 
#define LUA_AOT_LUAOPEN_NAME luaopen_benchmarks_queen_luaot
