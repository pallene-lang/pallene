    ...
    (void)x6;
    {
        ...
        while ((x10 >= 0 ? x7 <= x9 : x7 >= x9)) {
            ...
            (void) x11;
            {
                ...
                if (PALLENE_UNLIKELY(!ttisinteger(x13))) {
                    pallene_runtime_array_type_error(L, 4, LUA_TNUMINT, rawtt(x13));
                }
...
static int function_isplaceok_lua(lua_State *L)
{
    ...
    if (PALLENE_UNLIKELY(x5 != 3)) {
        pallene_runtime_arity_error(L, 3, x5);
    }
    TValue* x6 = s2v(x4 + 1);
    if (PALLENE_UNLIKELY(!ttistable(x6))) {
        pallene_runtime_argument_type_error(L, "a", 2, LUA_TTABLE, x6);
    }
    TValue* x7 = s2v(x4 + 2);
    if (PALLENE_UNLIKELY(!ttisinteger(x7))) {
        pallene_runtime_argument_type_error(L, "n", 2, LUA_TNUMINT, x7);
    }
    TValue* x8 = s2v(x4 + 3);
    if (PALLENE_UNLIKELY(!ttisinteger(x8))) {
        pallene_runtime_argument_type_error(L, "c", 2, LUA_TNUMINT, x8);
    }
    ...
    (void)x5;
    {
        ...
        while ((x8 >= 0 ? x6 <= x7 : x6 >= x7)) {
            ...
            (void) x9;
            {
                ...
                if (PALLENE_UNLIKELY(!ttisinteger(x11))) {
                    pallene_runtime_array_type_error(L, 18, LUA_TNUMINT, rawtt(x11));
                }
...
static int function_printsolution_lua(lua_State *L)
{
    ...
    TValue* x6 = s2v(x4 + 1);
    if (PALLENE_UNLIKELY(!ttisinteger(x6))) {
        pallene_runtime_argument_type_error(L, "N", 16, LUA_TNUMINT, x6);
    }
    TValue* x7 = s2v(x4 + 2);
    if (PALLENE_UNLIKELY(!ttistable(x7))) {
        pallene_runtime_argument_type_error(L, "a", 16, LUA_TTABLE, x7);
    }
...
static int function_addqueen_lua(lua_State *L)
{
    ...
    TValue* x6 = s2v(x4 + 1);
    if (PALLENE_UNLIKELY(!ttisinteger(x6))) {
        pallene_runtime_argument_type_error(L, "N", 34, LUA_TNUMINT, x6);
    }
    TValue* x7 = s2v(x4 + 2);
    if (PALLENE_UNLIKELY(!ttistable(x7))) {
        pallene_runtime_argument_type_error(L, "a", 34, LUA_TTABLE, x7);
    }
    TValue* x8 = s2v(x4 + 3);
    if (PALLENE_UNLIKELY(!ttisinteger(x8))) {
        pallene_runtime_argument_type_error(L, "n", 34, LUA_TNUMINT, x8);
    }
...
static int function_nqueens_lua(lua_State *L)
{
    ...
    TValue* x6 = s2v(x4 + 1);
    if (PALLENE_UNLIKELY(!ttisinteger(x6))) {
        pallene_runtime_argument_type_error(L, "N", 48, LUA_TNUMINT, x6);
    }
...
int luaopen_benchmarks_queen_pallene_handopt(lua_State *L)
{
    lua_checkstack(L, 4);
