...
static Table * function_sieve_titan(
    ...
    (void)x4;
    {
        ...
        {
        lua_Unsigned x7size = x7->sizearray;
        TValue *x7array = x7->array;
        ...
        lua_Unsigned x22size = x22->sizearray;
        TValue *x22array = x22->array;
...
int luaopen_benchmarks_sieve_hash_str(lua_State *L)
{
    lua_checkstack(L, 4);
