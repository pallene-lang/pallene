    ...
    (void)x4;
    {
        ...
        while ((x12 >= 0 ? x10 <= x11 : x10 >= x11)) {
            ...
            (void) x13;
            {
                ...
                if (PALLENE_UNLIKELY(x14 >= x7->sizearray)) {
                    pallene_renormalize_array(L, x7, x14, 5);
                }
            ...
            {
                {
                    ...
                    if (PALLENE_UNLIKELY(x25 >= x7->sizearray)) {
                        pallene_renormalize_array(L, x7, x25, 12);
                    }
                    ...
                    if (x27) {
                        ...
                        while ((x34 >= 0 ? x32 <= x33 : x32 >= x33)) {
                            ...
                            (void) x35;
                            {
                                ...
                                if (PALLENE_UNLIKELY(x36 >= x7->sizearray)) {
                                    pallene_renormalize_array(L, x7, x36, 16);
                                }
