...
// source = @benchmarks/spectralnorm/lua.lua
// main function
static
void magic_implementation_00(lua_State *L, CallInfo *ci)
{
 ...
 tailcall:
  ...
  // 9	[68]	SETFIELD 	5 0 4	; "Approximate"
  #undef  LUA_AOT_PC
...
static const char LUA_AOT_MODULE_SOURCE_CODE[] = {
  ...
  114, 101, 116, 117, 114, 110,  32, 123,  10,  32,  32,  32,  32,  65, 112, 112, 
  114, 111, 120, 105, 109,  97, 116, 101,  32,  61,  32,  65, 112, 112, 114, 111, 
  120, 105, 109,  97, 116, 101,  10, 125,  10,   0
};
 
#define LUA_AOT_LUAOPEN_NAME luaopen_benchmarks_spectralnorm_luaot
