...
return {
    A = A,
    MultiplyAv   = MultiplyAv,
    MultiplyAtv  = MultiplyAtv,
    MultiplyAtAv = MultiplyAtAv,
    Approximate = Approximate,

    injectA = function(f)
        A = f
    end,
    injectMultiplyAv = function(f)
        MultiplyAv = f
    end,
    injectMultiplyAtv = function(f)
        MultiplyAtv = f
    end,
    injectMultiplyAtAv = function(f)
        MultiplyAtAv = f
    end
}
