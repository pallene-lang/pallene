...
local corelib_headers
do
    local ok
    ok, corelib_headers = pcall(require, "pallene._corelibh")
    if not ok then
        error("Missing corelibh. You might need to re-generate the Pallene core library")
    end
end
...
function coder.generate(module, modname, pallene_filename)
    ...
    local head = c:generate_module_header()
    local body = c:generate_module_body()
    return head..body, {}
end
...
function Coder:generate_module_header()
    ...
    table.insert(out, [[
/* This file was generated by the Pallene compiler. */
/* Do not edit by hand */
]])

    table.insert(out, corelib_headers)
...
function Coder:generate_luaopen_function()
    ...
    return (util.render([[
        ...
        {
            /**/
            /* Check version, load Pallene library */
            /**/
...

            {
                ...
                lua_pushstring(L, "pallene._corelib");
                lua_call(L, 1, 1);

                const struct PalleneLib *lib = lua_topointer(L, -1);
                if (lib->version < PALLENE_LIB_VERSION) {
                    luaL_error(L,
                        PALLENE_SOURCE_FILE " was compiled for a newer version of Pallene. "
                        "Consider re-installing your Pallene");
                }
                if (lib->version > PALLENE_LIB_VERSION) {
                    luaL_error(L,
                        PALLENE_SOURCE_FILE " was compiled for an older version of pallene. "
