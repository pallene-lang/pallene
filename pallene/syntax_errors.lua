...
local errors = {
    ...
    -- This label is not thrown in rule 'import' because rule 'toplevelvar' matches an invalid input
    -- like "local bola import"
    AssignImport = "Expected '='.",

    -- This label is not thrown in rule 'import' because rule 'toplevelvar' matches an input like
    -- "local bola = X", given that X is a valid expression, or throws a label when X is not a valid
    -- expression
